...
const SECRET_NAME = process.env.SECRET_NAME || "SUPABASE_DATA_EXTRACTOR";
 ...
 * This function is designed to run only once per container lifetime (on cold starts).
 */
