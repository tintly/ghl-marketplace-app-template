/*
  ...
  1. Security Updates
    ...
    - Create properly permissive policies for authenticated users
    - Ensure service role maintains full access
    - Fix database function permissions

  2. Database Function
    - Update function to bypass RLS when needed
...
-- Update the database function with better RLS handling
