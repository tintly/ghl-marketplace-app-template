/*
  # Fix user_id indexing and RLS policies for ghl_configurations

  1. Indexes
    - Add composite indexes for better query performance
    - Ensure proper user_id indexing

  2. RLS Policies
    - Update policies to allow proper access patterns
    - Fix configuration lookup issues

  3. Helper Function
    - Add function for efficient configuration lookup
    - Handle linking scenarios properly
*/
...
-- Drop existing policies that might be too restrictive (but keep service_role policy)
